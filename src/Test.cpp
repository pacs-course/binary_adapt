...
void test3()
{
//TODO: does not work anymore, I changed the constructors
...
void test4(int argc, char ** argv)
{
	...
	libMesh::MeshTools::Generation::build_line(mesh, n, 0., 1., libMesh::EDGE2);
	...
	i.init();
//	size_t a(1);
//	double b = i.projectionError([](const Point<1>& p){return p.abs();},a); 
};
