...
**/
	template <size_t dim, BasisType FeType = InvalidFeType>
		class StdFElementInterface : public AbstractSpaceInterface<dim>, public Geometry::AbstractElement<dim>
		{
			protected:
/**
				default constructor.
...
**/
	...
	template <size_t dim, BasisType FeType>
		StdFElementInterface<dim, FeType>::~StdFElementInterface()
		{
			...
			//If a new std element is created after the destruction of this one, I want the InitNorms method to be called again
			this->_max_degree = 0;
		};
