	...
	{	
		...
		q_one_d_factory.add (Geometry::IntervalType,
									&HelperFunctions::Builders <LibmeshQuadratureRule<1, Geometry::IntervalType>,
																		...
																		>::BuildObject);
		cout << "Registrata in QuadratureFactory<1> quadratura con chiave: " << Geometry::IntervalType << endl;
...
//namespace
//{
//	LibmeshBinary::QuadratureRegister& qr(LibmeshBinary::QuadratureRegister::Instance());
