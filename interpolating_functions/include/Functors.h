...
/**
	Functor for square root function multiplied by the step function with step in x = 0.5
**/
...
/**
	Functor for identity function multiplied by the step function with step in x = 0.5
**/
...
/**
	Functor for square function multiplied by the step function with step in x = 0.5
**/
...
/**
	Functor for twentieth power function multiplied by the step function with step in x = 0.5
**/
...
**/
	...
	template <int b_mu>
		double AdvectionDiffusionSolution<b_mu>::operator() (const Geometry::Point<1>& p) const
		{
